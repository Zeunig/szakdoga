...
export const BigImageViewer = ({imagePath}: {imagePath: string}) => {
    return (
        <div style={{top: "0", display: "flex", flexDirection: "row", flexWrap: "wrap", justifyContent: "center", alignItems: "center", position: "fixed", zIndex: 999, width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.4)"}}>
