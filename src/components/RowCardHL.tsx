...
export default function RowCardHL({ car }: { car: ICarListing }) {
    return (


        <a href={`/cars/${car.id}`} target="_blank" className="">
                       
            <div className="mx-5 hvr-icon  transition-all duration-300 bg-white lg:bg-gradient-to-l to-white via-white from-orange-300 bg-size-200 bg-pos-0 hover:bg-pos-100  
                            border-4 border-orange-400 rounded-xl grid grid-flow-row lg:grid-cols-3 lg:h-52">
                ...
                <div className="py-4 w-full lg:col-span-2 h-full grid lg:grid-rows-3  lg:row-span-3 ">
                    ...
                    <div className="grid grid-flow-row lg:grid-cols-2 lg:grid-rows-2 row-span-2 ">
                        <div className="lg:row-start-2 row-start-1 col-start-1 text-3xl lg:text-2xl font-bold ml-10 lg:ml-0  w-fit  hvr-icon   ">

                            <div className="flex items-center">
                            {car.brand} {car.model}<Badge className="h-5 ml-5 bg-orange-600"> Kiemelt hirdetés</Badge>  
                            </div>
                    ...
                    <div className="text-gray-500 w-fit ml-5 lg:ml-0 tabular-nums grid grid-rows-2 text-center">
                        ...
                        <div className="row-span-1 row-start-1 md:hidden grid grid-flow-col gap-2">
