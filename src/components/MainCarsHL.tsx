    ...
    return (
        ...
        <a href={`/cars/${car.id}`} target="_blank" className="">
            ...
            <div className="mx-5 hvr-icon  transition-all duration-300 bg-white lg:bg-gradient-to-l to-white via-white from-orange-300 bg-size-200 bg-pos-0 hover:bg-pos-100  
                            border-4 border-orange-400 rounded-xl grid grid-flow-row lg:grid-cols-3 h-fit w-[340px] lg:w-fit lg:h-52 place-self-center">
                ...
                <div className="py-4 w-full lg:col-span-2 h-full grid grid-flow-row  lg:row-span-3">
                    ...
                    <div className="grid grid-flow-row lg:grid-cols-2 row-span-2 ">
                        <div className="lg:row-start-2 row-start-1 col-start-1 text-3xl lg:text-2xl font-bold ml-10 lg:ml-5  w-fit  hvr-icon   ">
                            ...
                            {car.brand} {car.model}<Badge className="h-5 ml-5 bg-orange-600 md:hidden"> Kiemelt hirdetés</Badge>
                            
                            </div>
                            <div className=""><Badge className="h-5 w-full bg-orange-600 hidden md:block text-center content-center"><p className="-my-1"> Kiemelt hirdetés</p></Badge>  </div>
                        </div>
