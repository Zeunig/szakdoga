            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6">
                  ...
                  <a
                    href="#"
                    className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white-900 hover:bg-black-50"
                  >
                    Autóvásárlás
                  </a>
                  <a
      ...
      <div id="main">
        <div className="mainimage">
          ...
          <div className="container mx-auto mt-4 h-full flex justify-around flex-col">
            <h1 className="text-3xl md:text-6xl font-black text-center main-text-shadow">Körpörgő Autókereskedés</h1>
            <SearchBox/>
          </div>
        </div>
      </div>
